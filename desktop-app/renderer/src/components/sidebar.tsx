...
const ICONS: Record<MenuItem["icon"], string> = {
  ...
  stethoscope: "M9 3a3 3 0 00-3 3v4a6 6 0 0012 0V6a3 3 0 00-3-3H9zM6 10V6a3 3 0 016 0v4a3 3 0 11-6 0zm9 0V6a3 3 0 016 0v4a6 6 0 01-6 6v2a4 4 0 008 0v-1",
  ...
  return (
    <aside className="flex w-64 flex-col bg-sidebar text-white">
      <div className="flex h-16 items-center gap-3 border-b border-white/10 px-6">
        ...
        <span className="text-lg font-semibold">Santé Québec</span>
      </div>
      ...
      <div className="border-t border-white/10 p-4">
        ...
        <p className="mt-0.5 text-sm font-medium">{getRoleLabel(user.role)}</p>
        <button
          onClick={logout}
          className="mt-3 w-full rounded-lg border border-white/20 py-1.5 text-xs text-slate-300 hover:bg-white/10 hover:text-white transition-colors"
        >
          Déconnexion
        </button>
      </div>
